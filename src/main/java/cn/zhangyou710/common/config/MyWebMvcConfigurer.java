...
public class MyWebMvcConfigurer implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        // 文件上传路径:把上传文件地址file:/data/youyou-net-disk/xxx.jpg  映射为 /uploads/**
        registry.addResourceHandler(fileServerProperties.getLocal().getUploadMapping() + "/**")
                .addResourceLocations("file:" + fileServerProperties.getLocal().getUploadDir());
    }
